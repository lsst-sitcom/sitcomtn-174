...
In this note, we have evaluated the impact of enabling chromatic PSF modeling during commissioning of the Vera C. Rubin Observatory using weekly DRP data (\texttt{w\_2025\_49}). By incorporating colour-dependent terms into the \texttt{PiFF} PSF model, we directly address wavelength-dependent effects, in particular Differential Chromatic Refraction (DCR), which is expected to be one of the dominant chromatic systematics in ground-based weak lensing measurements.
